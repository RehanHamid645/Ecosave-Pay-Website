...
export const metadata: Metadata = {
  ...
  keywords:['case studies',' helping businesses','Save money','Compare Business Utilities','edf business','british gas business','eon business energy','scottish power business energy',
    ...
    metadataBase: new URL('https://ecosavegasandpower.com/case-studies'),
  alternates: {
  canonical: '/case-studies',
    },
    openGraph: {
      title: 'Case Studies | Ecosave Gas & Power',
      description: '',
      url: 'https://ecosavegasandpower.com/case-studies',
