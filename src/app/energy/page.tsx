...
const faqs = [
  ...
  },
  {
    ...
    answer: "We only need your business name and postcode to compare rates. For the actual switch, you&apos;ll need your MPAN number (a 21-digit number beginning with 'S' found on your electricity bill)."
  },
  {
