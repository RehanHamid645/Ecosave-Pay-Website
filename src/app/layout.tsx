...
export const metadata: Metadata = {
  ...
  description:
    "Compare business gas & electricity with Ecosave Gas & Power — get instant quotes from leading UK suppliers, switch to the cheapest tariff and save up to 45% on energy. Compare and save on business energy, insurance, connectivity, and finance solutions.",
