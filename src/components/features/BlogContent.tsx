...
export default function BlogContent() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      >
        <h1 className="text-4xl font-bold mb-4">Energy Insights & Resources</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Stay informed about energy management, sustainability, and industry trends with our latest articles and guides.
        </p>
      </motion.div>
